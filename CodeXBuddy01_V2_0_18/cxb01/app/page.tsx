...
import { ArrowRight, Code, Globe, Mail, MessageSquare, Phone, Star, CheckCircle, Zap, Target, Smartphone, Search, ShoppingCart, Palette, TrendingUp, Menu, Users, Award, Clock } from 'lucide-react'
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-sm">
        <div className="container mx-auto max-w-7xl flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
            <Link href="#home" className="transition-colors hover:text-blue-600 text-gray-700">
              Home
            </Link>
            <Link href="#services" className="transition-colors hover:text-blue-600 text-gray-700">
              Services
            </Link>
            <Link href="#projects" className="transition-colors hover:text-blue-600 text-gray-700">
              Projects
            </Link>
            <Link href="#about" className="transition-colors hover:text-blue-600 text-gray-700">
              About
            </Link>
            <Link href="#contact" className="transition-colors hover:text-blue-600 text-gray-700">
              Contact
            </Link>
          </nav>
          ...
          <div className="flex items-center gap-2">
            <Button className="hidden sm:flex bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-4 lg:px-6 py-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 text-sm">
              Get Started
            </Button>
            {/* Mobile Menu Button */}
      ...
      <main className="flex-1">
        ...
        <section
          id="home"
          className="relative w-full py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 bg-gradient-to-br from-blue-50 via-white to-purple-50"
        >
              ...
              <div className="flex flex-col justify-center space-y-6 text-center lg:text-left">
                <div className="space-y-4">
                  <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-200 px-4 py-2 text-sm font-medium mx-auto lg:mx-0 w-fit">
                    🚀 Empowering Startups Since 2020
                  </Badge>
                  ...
                  <p className="max-w-2xl text-gray-600 text-lg md:text-xl leading-relaxed mx-auto lg:mx-0">
                    I help startups build powerful digital solutions that drive growth, attract investors, and scale
                    rapidly. From MVP to market leader - let's build your success story together.
                  </p>
                </div>
                
                <div className="flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start">
                  <Button className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 text-lg">
                    Start Your Project
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                  <Button
                    variant="outline"
                    className="w-full sm:w-auto border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold px-8 py-4 rounded-full transition-all duration-300 text-lg"
                  >
                    View Portfolio
                  </Button>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 pt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600 font-medium">50+ Happy Startups</span>
                  </div>
                  <div className="flex items-center gap-1">
                    {[1, 2, 3, 4, 5].map((i) => (
                      <Star key={i} className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                    ))}
                    <span className="text-sm text-gray-600 font-medium ml-1">5.0 Rating</span>
                  </div>
                </div>
              </div>
                ...
                <div className="relative w-full max-w-lg">
                  ...
                  <div className="relative bg-gradient-to-br from-blue-100 to-purple-100 rounded-3xl shadow-2xl p-8 h-96 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <h3 className="text-2xl font-bold text-gray-800 mb-2">Startup Success</h3>
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
              ...
              <p className="max-w-4xl text-gray-600 text-lg md:text-xl leading-relaxed">
                From concept to launch, I provide end-to-end digital services that help startups succeed in today's
                competitive market.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Custom web applications built with cutting-edge technologies like Next.js, React, and Node.js.",
                ...
                },
                {
                  ...
                  description: "Boost your online visibility and rank higher on search engines to attract more customers.",
                  color: "from-green-500 to-emerald-500",
                },
                {
                  icon: TrendingUp,
                  title: "Digital Marketing",
                  description: "Strategic marketing campaigns to increase brand awareness and drive business growth.",
                ...
                },
                {
                  ...
                  description: "Native and cross-platform mobile apps that engage users and drive business results.",
                ...
                },
                {
                  ...
                  description: "Rapid prototyping and MVP development to validate your startup idea quickly.",
        ...
        {/* Projects Section */}
        <section id="projects" className="w-full py-16 md:py-24 bg-gradient-to-br from-gray-50 to-blue-50">
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
              ...
              <p className="max-w-4xl text-gray-600 text-lg md:text-xl leading-relaxed">
                From idea to IPO-ready - see how I've helped startups build products that users love and investors fund.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "AI-powered project management tool that raised $2M in Series A",
                ...
                },
                {
                  name: "EcoMarket",
                  category: "E-commerce",
                  description: "Sustainable marketplace connecting eco-friendly brands with consumers",
                ...
                },
                {
                  name: "EduLearn",
                  category: "EdTech",
                  description: "Online learning platform with interactive courses and certifications",
                ...
                },
                {
                  ...
                  description: "Local food delivery platform connecting restaurants with customers",
                  metrics: "100+ restaurants",
                  icon: Smartphone,
                  color: "from-teal-500 to-blue-500",
                },
              ].map((project, index) => (
                <Card key={index} className="group overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 bg-white">
                  <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200">
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-purple-600/20"></div>
                    <div className={`absolute inset-0 bg-gradient-to-r ${project.color} opacity-10`}></div>
                    <div className="relative h-full flex items-center justify-center">
                      <div className={`p-6 rounded-full bg-gradient-to-r ${project.color}`}>
                        <project.icon className="h-12 w-12 text-white" />
                      </div>
                    </div>
                    <div className="absolute top-4 left-4">
                      <Badge className="bg-white/90 text-gray-800 font-semibold">{project.category}</Badge>
                    </div>
                  </div>
              ...
              <div className="flex flex-col justify-center space-y-6 text-center lg:text-left">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    A passionate full-stack developer and startup enthusiast with over 5 years of experience helping
                    startups transform their ideas into successful digital products.
                  </p>
                </div>

                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-gray-900">Why Startups Choose Me</h3>
                  <div className="space-y-3">
                    {[
                    ...
                    <CardContent className="p-0 text-center space-y-6">
                      <div className="relative w-32 h-32 mx-auto">
                        ...
                        <div className="relative w-full h-full bg-gradient-to-br from-blue-100 to-purple-100 rounded-full border-4 border-white shadow-lg flex items-center justify-center">
                          <span className="text-3xl font-bold text-blue-600">RK</span>
                        </div>
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900">Rakesh Kumar</h3>
                        <p className="text-blue-600 font-semibold">Founder & Full-Stack Developer</p>
                        <p className="text-gray-600 text-sm mt-2">Building the future, one startup at a time</p>
                      </div>
        ...
        {/* Contact Section */}
        <section id="contact" className="w-full py-16 md:py-24 bg-gradient-to-br from-blue-50 to-purple-50">
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
              <Badge className="bg-purple-100 text-purple-700 hover:bg-purple-200 px-4 py-2 text-sm font-medium">
                📞 Let's Connect
              ...
              <p className="max-w-4xl text-gray-600 text-lg md:text-xl leading-relaxed">
                Let's discuss your idea and create a roadmap to turn it into a successful business. I'm here to help you
              ...
              <div className="space-y-6">
                ...
                <Card className="border-0 shadow-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white">
                  <CardContent className="p-6 text-center space-y-4">
                    ...
                    <p className="text-blue-100">Book a free 30-minute consultation to discuss your startup idea</p>
          ...
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
            <div className="space-y-4 text-center sm:text-left">
              ...
              <p className="text-gray-400 text-sm">
                Empowering startups with cutting-edge digital solutions. From idea to IPO-ready.
              </p>
            </div>
